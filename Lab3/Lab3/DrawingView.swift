...
struct DrawingView: View {
    @ObservedObject var lines: ObservableArray<Line> = ObservableArray(array: []).observeChildrenChanges()
    @ObservedObject var straights: ObservableArray<Straight> = ObservableArray(array: []).observeChildrenChanges()
    @ObservedObject var ellipses: ObservableArray<Ellipse> = ObservableArray(array: []).observeChildrenChanges()
    @ObservedObject var rectangles: ObservableArray<Rectangle> = ObservableArray(array: []).observeChildrenChanges()
