...
struct DrawingView: View {
    @ObservedObject var lines: ObservableArray<PointShape> = ObservableArray(array: [])
    @ObservedObject var straights: ObservableArray<LineShape> = ObservableArray(array: [])
    ...
    @ObservedObject var dumbbells: ObservableArray<LineOOShape> = ObservableArray(array: [])
